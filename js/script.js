...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const revealElements = document.querySelectorAll('.section-header, .about-content, .skills-grid, .services-grid, .projects-grid, .contact-wrapper, .hero-content, .hero-image-wrapper, .stat-card, #stats .section-header');
