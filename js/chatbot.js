document.addEventListener('DOMContentLoaded', () => {
    ...
    const getBotResponse = (input) => {
        ...
        if (query.includes('who is vignesh') || query.includes('about the developer')) {
            return "Vignesh is a motivated Computer Science student at Stella Mary's College of Engineering, specializing in <b>DevOps Engineer</b>. He focuses on building automated pipelines and scalable infrastructure! 🚀";
        }
